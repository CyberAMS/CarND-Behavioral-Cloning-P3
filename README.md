...
The behavior cloning should be combined with a PID control of steering and throttle as mentioned in the [PID Controller](https://github.com/CyberAMS/CarND-PID-Control-Project) project.